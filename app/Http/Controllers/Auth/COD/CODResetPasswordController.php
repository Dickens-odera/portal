...
class CODResetPasswordController extends Controller
{
    use ResetsPasswords;
    /**
     ...
     */
    protected $redirectTo = '/cod/account/dashboard';
    /**
    ...
    {
        return Password::broker('cods');
    }
    public function showResetForm(Request $request, $token = null)
    {
        //dd($token);
        return view('auth.passwords.cod.reset')->with(['token'=>$token, 'email'=>$request->email]);
    }
