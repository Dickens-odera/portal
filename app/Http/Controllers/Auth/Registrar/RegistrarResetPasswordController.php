...
class RegistrarResetPasswordController extends Controller
{
    ...
    {
        return view('auth.passwords.registrar.reset')->with(['token'=>$token,'email'=>$request->email]);
    }
    public function reset(Request $request)
    {
        ...
        {
            $request->session()->flash('error','Failed to reset password, try again');
            return redirect()->back()->withInput($request->only('email','token'));
        }
