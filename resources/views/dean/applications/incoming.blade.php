                    ...
                    <table class="table table-bordered table-dark" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $value->status}}</td>
                                <td class="btn btn-group btn-group-sm" style="width:100%">
                                    <a href="{{ route('dean.application.incoming.view',['app_id'=>$value->app_id,'student'=>$value->student_name])}}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> </a>
