...
<html lang="en">
<head>
	<title>{{ config('app.name','MMUST INTER/INTRA SCHOOLS TRANSFER PORTAL')}}</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="post" action="{{ route('registrar.login.submit') }}">
                    {{ csrf_field() }}
