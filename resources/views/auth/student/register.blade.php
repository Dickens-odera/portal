			...
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
                    ...
                    <form action="{{ route('student.register') }}" method="POST">
						...
						<div class="input-group mb-3">
							...
							<input type="text" name="reg_number" class="form-control input_user" value="{{ old('reg_number') }}" placeholder="Reg/AdmNo">
						</div>
						<div class="input-group mb-3">
							<div class="input-group-append">
				...
				<div class="mt-4">
					<div class="d-flex justify-content-center links">
						Have an account? <a href="{{ route('student.login') }}" class="ml-2">Login</a>
					</div>
					{{-- <div class="d-flex justify-content-center links">
