...
@section('content')
    <div class="col-md-12">
        <div class="box">
            <div class="box-header bg-warning text-center text-uppercase">application sr no: {{ $application->app_id }}</div>
            <div class="box-body">
                            ...
                            <div class="box-body">
                                {!! Form::open() !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            @if(isset($application->students->email))
                                                    {!! Form::text('student_phone',$application->students->email , ['class'=>'form-control','disabled']) !!}
                                            @else
                                                    {!! Form::text('student_phone','' , ['class'=>'form-control','disabled']) !!}
                                            @endif
                                        </div>
                                    </div>
                                {!! Form::close() !!}
                ...
                <div class="col-md-12 row">
                    <div class="box">
                        <div class="box-header bg-success text-center text-uppercase">{{ __('cod and deans comments') }}</div>
                        <div class="box-body">
                            <div class="col-md-3">
                                <div class="box">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        {!! Form::label('comment','Comments', ['class'=>'col-md-4 form-label text-md-right']) !!}
                                        <div class="col-md-8">
                                            {!! Form::textarea('comment',old('comment'), ['class'=>'form-control','disabled'=>true]) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-8 col-md-offset-4">
