...
@section('content')
    <div class="box">
        <div class="box-header bg-warning text-center text-uppercase">{{ __('incoming applications for transfer') }} {{ __('receiving department')}} ({{ $department->name}})</div>
        <div class="box-body">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="btn-group btn-group-sm">
                                    <a href="{{ route('cod.applications.incoming.single.view',['app_id'=>$value->app_id]) }}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> View</a>
            ...
            @else
                   <div class="col-md-12">
                    <tr>
                        <td class="bg-warning">No applications found</td>
                    </tr>
                   </div>
            @endif
        </div>
