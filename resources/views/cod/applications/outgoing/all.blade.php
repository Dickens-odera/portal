...
@section('content')
    <div class="box">
        <div class="box-header bg-warning text-center text-uppercase">{{ __('applications for transfer') }} {{ __('current department')}} ({{ Auth::user()->department->name}})</div>
        <div class="box-body">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="btn-group btn-group-sm">
                                    <a href="{{ route('cod.applications.outgoing.single.view',['app_id'=>$value->app_id]) }}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> View</a>
            ...
            @else
                   <div class="col-md-12">
                    <tr>
                        <td class="">No applications found</td>
                    </tr>
                   </div>
            @endif
        </div>
